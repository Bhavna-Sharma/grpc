...
static void tls_server_authorization_check_callback(
  ...
  arg->error_details->set_err_details("callback_error_details");
}
...
TEST_F(CredentialsTest, TlsCredentialReloadConfigSchedule) {
  ...
  grpc_tls_credential_reload_arg* c_arg = new grpc_tls_credential_reload_arg();
  c_arg->error_details = new grpc_tls_err_details();
  c_arg->context = nullptr;
  TlsCredentialReloadArg* arg = new TlsCredentialReloadArg(c_arg);
...
TEST_F(CredentialsTest, TlsCredentialReloadConfigCppToC) {
  ...
  c_arg.error_details->set_err_details(test_error_details.c_str());
  ...
  EXPECT_STREQ(c_arg.error_details->err_details().c_str(), test_error_details.c_str());
...
TEST_F(CredentialsTest, TlsServerAuthorizationCheckConfigCppToC) {
  ...
  c_arg.error_details = new grpc_tls_err_details();
  c_arg.error_details->set_err_details("error_details");
  ...
  EXPECT_STREQ(c_arg.error_details->err_details().c_str(), "sync_error_details");
...
TEST_F(CredentialsTest, TlsCredentialsOptionsCppToC) {
  ...
  grpc::string test_error_details = "error_details";
  c_credential_reload_arg.error_details = new grpc_tls_err_details();
  c_credential_reload_arg.error_details->set_err_details(test_error_details.c_str());
  ...
  c_server_authorization_check_arg.error_details = new grpc_tls_err_details();
  c_server_authorization_check_arg.error_details->set_err_details("error_details");
  ...
  EXPECT_STREQ(c_credential_reload_arg.error_details->err_details().c_str(),
  ...
  EXPECT_STREQ(c_server_authorization_check_arg.error_details->err_details().c_str(),
               "sync_error_details");
